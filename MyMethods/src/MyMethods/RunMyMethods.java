...
public class RunMyMethods
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("My Methods class project:");
        System.out.println("Cody Beck \t Chelsea Coats \t Benjamin Wetteroff");
        System.out.println("Press the Enter key for main menu: \n");
        Menu();
    }
